...
- C3. H-02 premiers kills. **Moteur, API et restitution alpha termines le 21 septembre 2026** : team-kills exclus, preuve directe et chaque premier kill ouvre son round source. La position du tireur est echantillonnee exactement au tick du frag, puis agregee dans une grille monde ; sans echantillon exact, le kill reste consultable par round mais n'est pas place sur la grille.
